...
public static class Parameter
{
    ...
    // ボールの最低速度
    public static Vector2 BALL_MIN_VELOCITY = new Vector2(-2.0f, -2.0f);
    // ボールが反射する際の速度倍率
    ...
    public static float PADDLE_CHARGE_VELOCITY_MULTIPLY = 0.5f;
    // ボールの最大レベル
    public static int BALL_MAX_LEVEL = 20;
    // ボールの反射に成功した場合の速度倍率
    public static float SUCCESS_TO_REFLECT_BALL_VELOCITY_MULTIPLY = 1.2f;
